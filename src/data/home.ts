...
export const stores = [
  { name: 'Readings', location: 'Carlton', logo: '/assets/images/home/readings_logo.png' },
  { name: "Abbey's", location: 'Sydney', logo: '/assets/images/home/abbeys_logo.png' },
]
...
export const featuredBooks: BookEntry[] = [
  {
    ...
    buyUrl: 'https://www.amazon.com.au/MOSAIC-ESCALATOR-Mr-Michael-Nicholson/dp/B0CPDQLZHS',
    embedVideo: { id: '1016399714', source: 'vimeo' },
    bonusImage: { img: '/assets/images/books/mosaic_info.jpg', title: 'Finalist — Best Fiction Book Nomination' },
  },
  {
    title: 'Daughter to Bligh',
    coverImg: '/assets/images/books/book2_thumbnail.png',
    buyUrl: 'https://www.amazon.com.au/Daughter-Bligh-amazing-love-life/dp/B0CVLP1CJG',
