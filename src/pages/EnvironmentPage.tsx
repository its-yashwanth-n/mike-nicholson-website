      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {environmentLinks.map((link) => (
            <ExternalLinkCard key={link.url} title={link.title} url={link.url} img={link.img} />
          ))}
          <a
          ...
          >
            ...
            />
            <span>
              <span className="block text-sm font-medium text-text">This book is out now.</span>
              <span className="block text-sm text-accent">Click here to purchase</span>
            </span>
          </a>
        </div>
      </section>
